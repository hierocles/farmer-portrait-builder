        ...
        <div className="app__body">
          ...
          <main className="scenarios">
            ...
            <p className="scenarios__hint">
              Drag default portraits onto slots, upload unique portraits per scenario, drop multiple
              named PNGs onto a scenario card, copy portraits to other slots, or use bulk fill.
            </p>
